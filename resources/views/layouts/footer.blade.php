...
<footer>
    <div class="container">
        <div class="widget">
            <div class="rows">
                ...
                <div class="mt list">
                    ...
                    <li><i class="font bx bx-envelope"></i><a href="#">edwinalexander<br>bernardinomoran@gmail.com</a></li>
                </div>
        ...
        <div class="widget">
            <div class="rows">
                ...
                <div class="list">
                    <li><i class="font bx bx-chevron-right"></i><a href="#">Lorem ipsum dolor sit.</a></li>
                    <li><i class="font bx bx-chevron-right"></i><a href="#">Lorem ipsum dolor sit.</a></li>
                    <li><i class="font bx bx-chevron-right"></i><a href="#">Lorem ipsum dolor sit.</a></li>
                </div>
            </div>
    ...
    <div class="content">
        <div class="widgets">
            <div class="last-text">
                <p>&copy; Copyright by Alexander All Rights Reserved - {{ date('Y') }}.</p>
            </div>
        </div>
