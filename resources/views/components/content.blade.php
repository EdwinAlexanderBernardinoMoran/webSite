...
<section class="home">
    <div class="home-text">
        ...
        <div class="button">
            <a href="{{ asset('pdf/EDWIN-ALEXANDER-BERNARDINO-MORAN-CV.pdf', true) }}" target="_blank" download="/pdf/EDWIN-ALEXANDER-BERNARDINO-MORAN-CV.pdf" class="btn">Descargar CV</a>
        </div>
    </div>
</section>
